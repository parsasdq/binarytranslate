            ...
            child: Column(
                children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Text('زبان مبدا',style: style.tabe_style,),
                      Text('زبان مقصد',style: style.tabe_style,)
                    ],),
                      ...
                      Directionality(
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonFormField<String>(items: srclanguage.map((item) => DropdownMenuItem<String>(
                              child: Text(item,style: style.tabe_style,),
                              value: item,
                          ...
                          InkWell(child: Icon(Icons.swipe_rounded,color: Colors.blue,),onTap: (){
                            setState(() {
                              var deslocal=SelectedDESLanguage;
                              SelectedDESLanguage=SelectedSCRLanguage;
                              SelectedSCRLanguage=deslocal;
                            });
                          },),
                           Directionality(
                          textDirection: TextDirection.rtl,
                  ...
                  Container(height: 140,width: 400,
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        maxLines: 4,
                        decoration: InputDecoration(
                          labelStyle: style.tabe_style,
                          hintText: 'متن خود را وارد نمایید'
                              '\ntype your text here',
                          hintStyle: style.tabe_style,
                  ...
                  MaterialButton(
                    ...
                    child: Text('ترجمه کن',style: style.button_style,),
                      ...
                      Container(
                        ...
                        child: Center(child:Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            ...
                            Text(namayesh,style: style.tabe_style,),
                          ],
                        ),),
                      )],)
                ]),
